    ...
    <div class="container mx-auto p-6">
        <div class="bg-white p-6 shadow rounded-lg">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-bold">Range</h2>
                <form method="GET" action="{{ route('range') }}">
            ...
            <p class="mb-4">Data Hasil Range Universitas</p>
            <table class="table-auto w-full border-collapse border border-gray-200 text-left">
                <thead>
                    <tr>
                        ...
                        <th class="border border-gray-200 px-4 py-2">C1 (SPP)</th>
                        <th class="border border-gray-200 px-4 py-2">C2 (Akreditasi)</th>
                        <th class="border border-gray-200 px-4 py-2">C3 (Dosen S3)</th>
                        <th class="border border-gray-200 px-4 py-2">C4 (Lokasi)</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($mappedUniversities as $university)
                        <tr>
                            ...
                            <td class="border border-gray-200 px-4 py-2">{{ $university['mapped']['Akreditasi'] }}</td>
                            <td class="border border-gray-200 px-4 py-2">{{ $university['dosen_s3'] }}</td>
                            <td class="border border-gray-200 px-4 py-2">{{ $university['mapped']['Lokasi'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
