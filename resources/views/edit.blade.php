            ...
            <form action="{{ route('universities.update', $university->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select id="lokasi" name="lokasi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        <option value="Satu Kota" {{ $university->lokasi == 'Satu Kota' ? 'selected' : '' }}>Satu Kota</option>
                        <option value="Beda Kota" {{ $university->lokasi == 'Beda Kota' ? 'selected' : '' }}>Beda Kota</option>
                    </select>
                </div>
